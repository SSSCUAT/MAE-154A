...
Wstruct = 4.2381; % total weight of empty aircrafts (lbs)
Wf = 0.5225;      % weight of fuselage (lbs)
Ww = 1.2332;      % Weight of wing
Wht = 0.6342;  % weight of horizontal tail
Wvt = 0.3482;  % weight of vertical tail
